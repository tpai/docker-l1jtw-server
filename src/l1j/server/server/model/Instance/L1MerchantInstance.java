	...
	public void onTalkAction(L1PcInstance player) {
		...
		if (talking != null) {
			if (npcid == 70841) { // ルーディエル
				...
				String[] html1 =
				{ "alfons1", "cbk1", "cbk2", "cbk3", "cbk4", "cbk5", "cbk6", "cbk7", "cbk8" }; // 0
																								// ~
																								// 8
				String[] html2 =
				{ "cyk1", "cyk2", "cyk3", "cyk4", "cyk5", "cyk6", "cyk7", "cyk8" }; // -1
																					// ~
																					// -8
				if (karmaLevel < 0) {
				...
				int karmaLevel = player.getKarmaLevel();
				String[] html =
				{ "lsmith0", "lsmith1", "lsmith2", "lsmith3", "lsmith4", "lsmith5", "lsmith7", "lsmith8" };
				if (karmaLevel <= 8) {
				...
				if (player.getLevel() < 12) {
					...
					if (player.getInventory().checkItem(41230) || player.getInventory().checkItem(41231) || player.getInventory().checkItem(41232)
							|| player.getInventory().checkItem(41233) || player.getInventory().checkItem(41235)
				...
				if (player.getQuest().get_step(L1Quest.QUEST_RESTA) == 3) {
					htmlid = "lukein13";
						...
						&& (player.getQuest().get_step(L1Quest.QUEST_RESTA) == 2) && player.getInventory().checkItem(40631)) {
					htmlid = "lukein10";
				}
				else if (player.getQuest().get_step(L1Quest.QUEST_LUKEIN1) == L1Quest.QUEST_END) {
					htmlid = "lukein0";
				...
				else if (((player.getQuest().get_step(L1Quest.QUEST_SIMIZZ) == 2) && (player.getQuest().get_step(L1Quest.QUEST_CADMUS) == 1))
				...
				if (!player.isElf()) {
				...
				else if ((player.getQuest().get_step(L1Quest.QUEST_MOONOFLONGBOW) == 4) && player.getInventory().checkItem(40048, 10)
						&& player.getInventory().checkItem(40049, 10) && player.getInventory().checkItem(40050, 10)
					...
					htmlid = "zybril3";
						...
						&& ((player.getQuest().get_step(L1Quest.QUEST_MOONOFLONGBOW) == 2) || (player.getQuest()
								.get_step(L1Quest.QUEST_MOONOFLONGBOW) == 1))) {
					htmlid = "zybril1";
				}
				else {
					htmlid = "zybril1";
				...
				else if (player.isCrown() || player.isDarkelf() || player.isKnight() || player.isWizard() || player.isDragonKnight()
				...
				else if (player.getInventory().checkItem(40679) || player.getInventory().checkItem(40680) || player.getInventory().checkItem(40681)
						|| player.getInventory().checkItem(40682) || player.getInventory().checkItem(40683) || player.getInventory().checkItem(40684)
